...
if [ $HTTP_CODE != "404" ]; then
    ...
    datamodel-codegen  --input ./specification-$answer/schema/bom-$answer.schema.json --input-file-type jsonschema --output ./hoppr-cyclonedx-models/$py_file
    sed -i s/unique_items=True/"'REMOVED LM unique_items=True'"/g ./hoppr-cyclonedx-models/$py_file/__init__.py
else 
