...
if [ $HTTP_CODE != "404" ]; then
    ...
    poetry run python -m datamodel-codegen --input ./specification-$answer/schema/bom-$answer.schema.json --input-file-type jsonschema --output ./hoppr_cyclonedx_models/$py_file
